package com.example.springbootbankexample.controller
...
internal class BankControllerTest @Autowired constructor(
    ...
    inner class PatchExistingBank {
        ...
        fun `should update an existing bank`() {
            // given
            val updatedBank = Bank("1234", 32.0, 1)
        ...
        @Test
        fun `should return NOT FOUND if not bank with given account number exists`() {
            // given
